...
mine_fp="JH_OTUs_nosigs_env.csv,allpairs,cv=0.0,B=n^0.6,Results.csv"
...
write.table(combined, "JH_OTUs_nosigs_env.csv,allpairs,cv=0.0,B=n^0.6,Results,adjp.txt", quote=FALSE, sep="\t")
...
mine_fp="JH_OTUs_nosigs_env.csv,allpairs,cv=0.0,B=n^0.6,Results,adjp.txt"
mine2Cytoscape.f(mine_fp, name="JH_OTUs_nosigs_env")
